...
class FuncLib {
	...
	/**
	 * get backend fileroot
	 *
	 * String unknown_type $filename
	 *
	 * @return String
	 */
	public static function getBEFileroot($filename) {
		return "../../../../" . $filename;
	}
	 ...
	 * @return Boolean
	 */
	public static function isValidWhereStatement($where_statement) {
		$needle = array (
				'DROP',
				'UPDATE',
				'DELETE',
		...
		foreach ( $needle as $substring ) {
			$count += substr_count ( $where_statement, $substring );
		}
		return ($count <= 0);
	}
