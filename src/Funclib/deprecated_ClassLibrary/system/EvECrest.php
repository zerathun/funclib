...
class EvECrest {
	...
	public $crest_url = "https://crest-tq.eveonline.com/";
	private $filename_requestcounter = "/var/www/phpBB3/ext/zeradun/api_manager/includes/Ember/Cache/CREST_Requestcounter.txt";
	...
	public static function getInstance() {
		if(empty(EvECrest::$instance)) {
			EvECrest::$instance = new EvECrest();
		}
		return EvECrest::$instance;
	}
