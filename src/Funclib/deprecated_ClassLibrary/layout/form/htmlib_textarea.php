...
use zeradun\api_manager\includes\Ember\ClassLibrary\layout\iface\htmlib_Iattr_cols;
...
use zeradun\api_manager\includes\Ember\ClassLibrary\layout\attributes\htmlib_attr_rows;
use zeradun\api_manager\includes\Ember\ClassLibrary\layout\attributes\htmlib_attr_cols;
 ...
 *       
 */
class htmlib_textarea extends htmlib_parent implements htmlib_I_layout, htmlib_I_content, htmlib_Iattr_disabled, htmlib_Iattr_multiple, htmlib_Iattr_name, htmlib_Iattr_onblur, htmlib_Iattr_onchange, htmlib_Iattr_onfocus, htmlib_Iattr_size, htmlib_Iattr_tableindex, htmlib_Iattr_type, htmlib_Iattr_onselect, htmlib_Iattr_rows, htmlib_Iattr_cols {
	protected $content = '';
	...
	public function setRows($rows) {
		$this->addAttribute ( new htmlib_attr_rows ( $rows ) );
	}
	public function getRows() {
		return $this->getAttribute ( 'htmlib_attr_rows' );
	}
	public function setCols($cols) {
		$this->addAttribute ( new htmlib_attr_cols ( $cols ) );
	}
	public function getCols() {
		return $this->getAttribute ( 'htmlib_attr_cols' );
	}
